const CACHE='conectalsch-v132-personal-envelope-'+encodeURIComponent(self.registration.scope);
const CORE=['./','./index.html','./style.css','./app.js','./recognition-math.js','./recognition-clock.js','./temporal-sequence.js','./motion-event.js','./visual-provider.js','./visual-tracking.js','./recognition-state.js','./sample-store.js','./manifest.webmanifest','./icon.svg','./hand-overlay.js','./content-store.js','./notes-ui.js','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
