...
## Reconocimiento de movimiento v1.2.8
...
Descomprime el ZIP y reemplaza los archivos de la raíz del repositorio. El service worker usa una caché nueva para v1.2.8. Abre la web con conexión y acepta la actualización; si el iPhone conserva una versión anterior, cierra la PWA y sus pestañas y vuelve a abrirla.
