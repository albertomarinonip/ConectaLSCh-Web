...
// A real sign supported by a majority of five personal examples may become a candidate.
r=chooseSign([
...
console.log('PASS v1.3 open-set consensus rejects a one-template false positive and accepts majority agreement');
